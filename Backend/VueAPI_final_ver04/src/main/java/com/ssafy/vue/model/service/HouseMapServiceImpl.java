...
//	}
	...
	@Override
	public List<SidoGugunCodeDto> getSidoByCode(String sido) throws Exception {
		return sqlSession.getMapper(HouseMapMapper.class).getSidoByCode(sido);
	}

	@Override
	public List<SidoGugunCodeDto> getGugunByCode(String gugun) throws Exception {
		return sqlSession.getMapper(HouseMapMapper.class).getGugunByCode(gugun);
	}
